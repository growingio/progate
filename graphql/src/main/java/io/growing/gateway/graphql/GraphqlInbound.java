...
public class GraphqlInbound implements Inbound {
    ...
    @Override
    public Set<HttpEndpoint> endpoints(List<ServiceMetadata> services, Set<Outgoing> outgoings, RuntimeContext context) {
        ...
        final Handler<HttpServerRequest> handler = new GraphqlEndpointHandler(config, services, outgoings, context);
