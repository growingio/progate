...
public class GraphqlSchemaParser {
    ...
    public TypeDefinitionRegistry parse(final List<ModuleScheme> schemes) {
        return new SchemaParser().parse(mergeGraphqlDefinitions(schemes));
    }

    public String mergeGraphqlDefinitions(final List<ModuleScheme> schemes) {
                    ...
                    for (EndpointDefinition def : scheme.graphqlDefinitions()) {
                        ...
                        for (String line : lines) {
                            ...
                            if (matched) {
                                ...
                                others.append(line).append(StringUtils.LF);
                            }
                        }
        ...
        final StringBuilder results = new StringBuilder(others);
